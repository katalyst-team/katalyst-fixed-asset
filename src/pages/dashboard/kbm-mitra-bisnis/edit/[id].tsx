...
function EditKbmMitraBisnisContent() {
  ...
  if (isError || !itemData) {
    return (
      <div className="container mx-auto py-6 px-4">
        <h1 className="text-2xl font-bold">Mitra Bisnis not found</h1>
        <p className="text-muted-foreground mt-2">
          The mitra bisnis you are looking for does not exist or has been deleted.
        </p>
      </div>
    );
  }
...
export default function EditKbmMitraBisnisPage() {
  ...
  const seo = createPageSEO({
    ...
    description: "Update KBM Mitra Bisnis data.",
    path: "/dashboard/kbm-mitra-bisnis/edit/[id]",
    title: "Edit KBM Mitra Bisnis",
  });
