...
export default function DetailKbmGradeStBatang() {
  ...
  const seo = createPageSEO({
    ...
    description:
      "See KBM Grade ST Batang details, RFID history, and availability in one view.",
    path: "/dashboard/kbm-grade-st-batang/[id]",
    title: "KBM Grade ST Batang Detail",
  });
