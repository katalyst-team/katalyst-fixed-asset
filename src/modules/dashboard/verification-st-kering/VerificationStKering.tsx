...
import { VerificationStKeringHeader } from "./components";

const LIMIT = 20;

const VerificationStKering = () => {
  const { t } = useTranslation("verification-st-kering");
  ...
  const { data, isLoading, refetch } = useGetPendingVerificationQuery({
    ...
    module: StockMovementTypeNameEnum.ST_KERING_STORED,
    organizationId,
    storeId,
  });
...
export default VerificationStKering;
