...
interface OutboundPenerimaanLogFilterContentProps {
...
const OutboundPenerimaanLogFilterContent: React.FC<
  OutboundPenerimaanLogFilterContentProps
> = (props) => {
...
export default OutboundPenerimaanLogFilterContent;
