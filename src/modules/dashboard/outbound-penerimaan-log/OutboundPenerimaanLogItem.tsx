...
interface OutboundPenerimaanLogItemProps {
...
const OutboundPenerimaanLogItem: React.FC<OutboundPenerimaanLogItemProps> = ({
  commonAttributes,
  isColumnVisible,
  item,
  num,
  ...
  return (
    <TableRow>
      ...
      {isColumnVisible(COLUMN_ID_REFERENCE_NUMBER) && (
        <TableCell>{formatValue(item.reference_number)}</TableCell>
      )}
...
export default OutboundPenerimaanLogItem;
