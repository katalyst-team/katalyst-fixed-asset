...
import OutboundPenerimaanLogCategoryFilter from "./components/OutboundPenerimaanLogCategoryFilter";
import { StoreSelector } from "./components/StoreSelector";
import OutboundPenerimaanLogFilter from "./OutboundPenerimaanLogFilter";
import { useOutboundPenerimaanLogStore } from "./store";

interface OutboundPenerimaanLogHeaderProps {
...
const OutboundPenerimaanLogHeader: React.FC<OutboundPenerimaanLogHeaderProps> = ({
  allColumns,
  nextCursor,
  onHideAll,
  onShowAll,
  ...
  const exportTypeIds =
    (filters.stock_movement_type_ids && filters.stock_movement_type_ids.length > 0
      ...
      : outboundPenerimaanLogTypeIds) ?? outboundPenerimaanLogTypeIds;
  ...
  return (
    <div className="flex w-full flex-col gap-2">
      <div className="flex flex-wrap gap-2 items-center">
        ...
        />
        <OutboundPenerimaanLogCategoryFilter />
        <OutboundPenerimaanLogFilter />
        <ColumnVisibility
          columns={allColumns}
...
export default OutboundPenerimaanLogHeader;
