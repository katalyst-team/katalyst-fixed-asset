        ...
        <div className="ks-card-body" style={{ ...flexCol, gap: 14 }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button
              ...
              type="button"
              onClick={() => toast.success(`${wo.id} marked in-progress`)}
            >
              Start work
            </button>
            <button
              className="ks-btn"
              type="button"
              onClick={() => toast.success(`${wo.id} closed`)}
            >
...
export function ScheduleTab() {
  ...
  const [selAsset, setSelAsset] = useState(PRE_USE_ASSETS[0].id);
          ...
          <div className="ks-card">
            ...
            <div className="ks-card-body">
              ...
              <button
                ...
                type="button"
                onClick={() => toast.success(`Checklist submitted for ${asset.id}`)}
              >
                Submit inspection
              </button>
            </div>
