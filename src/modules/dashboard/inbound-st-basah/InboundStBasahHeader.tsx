...
import InboundStBasahFilter from "./InboundStBasahFilter";
import { useInboundStBasahStore } from "./store";

interface InboundStBasahHeaderProps {
...
const InboundStBasahHeader: React.FC<InboundStBasahHeaderProps> = ({
  allColumns,
  nextCursor,
  onHideAll,
  onShowAll,
  ...
  const exportTypeIds =
    (filters.stock_movement_type_ids && filters.stock_movement_type_ids.length > 0
      ...
      : inboundStBasahTypeIds) ?? inboundStBasahTypeIds;
...
export default InboundStBasahHeader;
