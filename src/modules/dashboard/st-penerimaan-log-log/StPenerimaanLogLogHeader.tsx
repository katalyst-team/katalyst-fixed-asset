...
interface StPenerimaanLogLogHeaderProps {
...
const StPenerimaanLogLogHeader: React.FC<StPenerimaanLogLogHeaderProps> = ({
  allColumns,
  nextCursor,
  onHideAll,
  onShowAll,
      ...
      <div className="flex flex-col w-full gap-2 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col w-full gap-2 sm:flex-row sm:flex-1">
          ...
          <Input
            ...
            placeholder={t(
              "st-penerimaan-log-log:filter.rfidSearchPlaceholder",
              "Search RFID...",
            )}
          ...
          <Input
            className="w-full sm:w-[220px] sm:flex-none"
            placeholder={t(
              "st-penerimaan-log-log:filter.internalCodePlaceholder",
              "Enter internal code...",
            )}
...
export default StPenerimaanLogLogHeader;
