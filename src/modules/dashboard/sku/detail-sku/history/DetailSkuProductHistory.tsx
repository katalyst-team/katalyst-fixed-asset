...
import DetailSkuProductHistoryItem from "./DetailSkuProductHistoryItem";
import { useDetailSkuProductHistory } from "./useDetailSkuProductHistory";

const DetailSkuProductHistoryPage = () => {
            ...
            <Table className="border shadow-md rounded-md">
              ...
              <TableBody>
                {detailSkuProductHistoryData.map((item) => (
                  <DetailSkuProductHistoryItem key={item.no} item={item} />
                ))}
              </TableBody>
            </Table>
          </div>
...
export default DetailSkuProductHistoryPage;
