...
import LaminaOutboundLogCategoryFilter from "./components/LaminaOutboundLogCategoryFilter";
import { StoreSelector } from "./components/StoreSelector";
import LaminaOutboundLogFilter from "./LaminaOutboundLogFilter";
import { useLaminaOutboundLogStore } from "./store";

interface LaminaOutboundLogHeaderProps {
...
const LaminaOutboundLogHeader: React.FC<LaminaOutboundLogHeaderProps> = ({
  allColumns,
  nextCursor,
  onHideAll,
  onShowAll,
  ...
  return (
    <div className="flex w-full flex-col gap-2">
      <div className="flex flex-wrap gap-2 items-center">
        ...
        />
        <LaminaOutboundLogCategoryFilter />
        <LaminaOutboundLogFilter />
        <ColumnVisibility
          columns={allColumns}
...
export default LaminaOutboundLogHeader;
