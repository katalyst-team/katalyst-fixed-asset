...
import LaminaOutboundLogHeader from "./LaminaOutboundLogHeader";
import LaminaOutboundLogItem from "./LaminaOutboundLogItem";
import { useLaminaOutboundLogStore } from "./store";
import { useLaminaOutboundLog } from "./useLaminaOutboundLog";
...
const LaminaOutboundLog = () => {
  ...
  const {
    ...
    prevCursor,
    totalCount,
  } = useLaminaOutboundLog();
  const { tokenPayload } = useUser();

  const currentPage = useLaminaOutboundLogStore((state) => state.currentPage);
  ...
  const {
    ...
    hideAllColumns,
    visibleColumns,
  } = useColumnVisibility("lamina-outbound-log", allColumns);
...
export default LaminaOutboundLog;
