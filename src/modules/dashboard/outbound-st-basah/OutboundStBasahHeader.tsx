...
import OutboundStBasahFilter from "./OutboundStBasahFilter";
import { useOutboundStBasahStore } from "./store";

interface OutboundStBasahHeaderProps {
...
const OutboundStBasahHeader: React.FC<OutboundStBasahHeaderProps> = ({
  allColumns,
  nextCursor,
  onHideAll,
  onShowAll,
  ...
  const exportTypeIds =
    (filters.stock_movement_type_ids && filters.stock_movement_type_ids.length > 0
      ...
      : outboundStBasahTypeIds) ?? outboundStBasahTypeIds;
...
export default OutboundStBasahHeader;
