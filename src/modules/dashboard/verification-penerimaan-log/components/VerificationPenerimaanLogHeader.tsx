...
interface VerificationPenerimaanLogHeaderProps {
  onStoreChange: (value: string | undefined) => void;
  storeFilter: string | undefined;
  stores: StoreOption[];
}

const VerificationPenerimaanLogHeader = ({
  onStoreChange,
  storeFilter,
  stores,
}: VerificationPenerimaanLogHeaderProps) => {
...
export default VerificationPenerimaanLogHeader;
