...
import LaminaInboundLogCategoryFilter from "./components/LaminaInboundLogCategoryFilter";
import { StoreSelector } from "./components/StoreSelector";
import LaminaInboundLogFilter from "./LaminaInboundLogFilter";
import { useLaminaInboundLogStore } from "./store";

interface LaminaInboundLogHeaderProps {
...
const LaminaInboundLogHeader: React.FC<LaminaInboundLogHeaderProps> = ({
  allColumns,
  nextCursor,
  onHideAll,
  onShowAll,
  ...
  const exportTypeIds =
    (filters.stock_movement_type_ids && filters.stock_movement_type_ids.length > 0
      ...
      : inboundLogTypeIds) ?? inboundLogTypeIds;
  ...
  return (
    <div className="flex w-full flex-col gap-2">
      <div className="flex flex-wrap gap-2 items-center">
        ...
        />
        <LaminaInboundLogCategoryFilter />
        <LaminaInboundLogFilter />
        <ColumnVisibility
          columns={allColumns}
...
export default LaminaInboundLogHeader;
