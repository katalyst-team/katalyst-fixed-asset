...
import InboundLogFilter from "./InboundLogFilter";
import { useInboundLogStore } from "./store";

interface InboundLogHeaderProps {
...
const InboundLogHeader: React.FC<InboundLogHeaderProps> = ({
  allColumns,
  nextCursor,
  onHideAll,
  onShowAll,
...
export default InboundLogHeader;
