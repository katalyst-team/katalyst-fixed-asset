...
interface KbmKayuStKeringListContextType {
...
const KbmKayuStKeringListContext = createContext<KbmKayuStKeringListContextType | undefined>(undefined);

export const KbmKayuStKeringListProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <KbmKayuStKeringListContext.Provider
      value={{
        categoryData,
        currentPage,
        filters,
...
export const useKbmKayuStKeringList = (): KbmKayuStKeringListContextType => {
  const context = useContext(KbmKayuStKeringListContext);
  if (!context) throw new Error("useKbmKayuStKeringList must be used within KbmKayuStKeringListProvider");
  return context;
};
