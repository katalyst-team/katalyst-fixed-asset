...
const KAYU_ST_KERING_PREFIX = "SAWN TIMBER KERING ";

interface KbmKayuStKeringModalAddProps {
...
const KbmKayuStKeringModalAdd = ({
  ...
  const handleSubmit = async () => {
    ...
    if (!finalName.startsWith(KAYU_ST_KERING_PREFIX)) {
      finalName = `${KAYU_ST_KERING_PREFIX}${finalName}`;
    }
      ...
      <DialogContent className="sm:max-w-[480px] max-h-[90vh] overflow-hidden">
        ...
        <ScrollArea className="max-h-[60vh] pr-2">
          <div className="flex flex-col gap-4 py-4 pr-2">
            ...
            <div className={hasSubCategory ? "pointer-events-none opacity-50" : undefined}>
              <div className="grid gap-2">
                <Label>{t("modal.add.attributes")}</Label>
...
export default KbmKayuStKeringModalAdd;
