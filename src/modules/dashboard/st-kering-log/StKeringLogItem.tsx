...
interface StKeringLogItemProps {
  item: SkuItemType;
...
const StKeringLogItem: React.FC<StKeringLogItemProps> = ({
  isColumnVisible,
  item,
  num,
  uniqueAttributes,
  ...
  const { BadgeComponent: itemStatusBadge } = useBadgeStatus(
    itemStatus || "",
    {
      ...
      translationNamespace: "st-kering-log",
    }
  );
              ...
              <div className="flex -space-x-2">
                {imageUrls.slice(0, 3).map((imageUrl, imgIndex) => (
                  ...
                  >
                    <Image
                      fill
                      alt={t("st-kering-log:item.imageAlt", {
...
export default StKeringLogItem;
