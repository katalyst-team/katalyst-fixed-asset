...
interface PenerimaanLogHeaderProps {
...
const PenerimaanLogHeader: React.FC<PenerimaanLogHeaderProps> = ({
  allColumns,
  nextCursor,
  onHideAll,
  onShowAll,
  ...
  return (
    <div className="flex flex-wrap w-full items-center gap-2">
      <Button
        size="sm"
        onClick={() => router.push("/dashboard/penerimaan-log/create")}
      >
        <Plus className="mr-2 h-4 w-4" />
        {t("penerimaan-log:header.createButton", "Buat Penerimaan Log")}
      </Button>
      <StoreSelector
      ...
      <Input
        ...
        placeholder={t(
          "penerimaan-log:filter.rfidSearchPlaceholder",
          "Search RFID...",
        )}
      ...
      <Input
        className="w-[180px] flex-none"
        placeholder={t(
          "penerimaan-log:filter.internalCodePlaceholder",
          "Enter internal code...",
        )}
...
export default PenerimaanLogHeader;
