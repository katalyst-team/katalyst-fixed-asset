...
const StKeringGradePage = () => {
  ...
  const selectedCategory = useMemo(
    () => stKeringCategories.find((c) => c.id === selectedCategoryId),
    [stKeringCategories, selectedCategoryId],
  );
  ...
  useEffect(() => {
    if (!selectedCategoryId && stKeringCategories.length > 0) {
      setSelectedCategoryId(stKeringCategories[0].id);
    }
  }, [stKeringCategories, selectedCategoryId]);
...
export default StKeringGradePage;
